...
class DiCy extends _StateConsumer2.default {
  static create(filePath, options = {}) {
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      const state = yield _State2.default.create(filePath, schema);
  ...
  static getOptionDefinitions() {
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      const schema = yield _File2.default.load(filePath);
      const options = [];
