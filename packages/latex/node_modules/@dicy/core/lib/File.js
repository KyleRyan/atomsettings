...
class File {
  ...
  static loadFileTypes() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      if (!_this.fileTypes) {
        ...
        const value = yield _this.load(fileTypesPath);
  ...
  isFileType(name, fileType) {
    ...
    if (!fileType.fileName && !fileType.contents) {
      ...
      return _promise2.default.resolve(isMatch);
    }
      ...
      if (fileType.contents) {
        ...
        File.canRead(this.realFilePath).then(canRead => {
          if (canRead) {
            ...
            const rl = _readline2.default.createInterface({
              input: _fsExtra2.default.createReadStream(this.realFilePath)
            });
            let match = false;
  ...
  delete() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      if (!_this3.virtual) yield File.remove(_this3.realFilePath);
    })();
  }
  ...
  updateTimeStamp() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      // is set.
      if (_this4.virtual) return false;

      // Save the old time stamp and get the current one.
      const oldTimeStamp = _this4.timeStamp;
      _this4.timeStamp = yield File.getModifiedTime(_this4.realFilePath);

      // Return true indicating an updated time stamp if there was no time stamp
      // before or the new time stamp is more recent.
      return !oldTimeStamp || oldTimeStamp < _this4.timeStamp;
    })();
  }
  ...
  update() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      const updated = (yield _this5.updateTimeStamp()) && (yield _this5.updateHash());
      _this5.hasBeenUpdated = _this5.hasBeenUpdated || updated;
    })();
  }
  ...
  static dump(filePath, value) {
    return (0, _asyncToGenerator3.default)(function* () {
      const contents = _jsYaml2.default.dump(value, { skipInvalid: true });
      yield _fsExtra2.default.writeFile(filePath, contents);
    })();
  }

  static safeDump(filePath, value) {
    return (0, _asyncToGenerator3.default)(function* () {
      const contents = _jsYaml2.default.safeDump(value, { skipInvalid: true });
      yield _fsExtra2.default.writeFile(filePath, contents);
    })();
  }
