...
class PsToPdf extends _Rule2.default {
  ...
  constructCommand() {
    return {
      args: ['ps2pdf', '{{$FILEPATH_0}}', '{{$DIR_0/$NAME_0.pdf}}'],
      cd: '$ROOTDIR',
      severity: 'error',
...
exports.default = PsToPdf;
PsToPdf.parameterTypes = [new _set2.default(['PostScript'])];
PsToPdf.description = 'Converts PS to PDF using ps2pdf.';