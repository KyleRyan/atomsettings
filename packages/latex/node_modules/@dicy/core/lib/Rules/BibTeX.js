...
class BibTeX extends _Rule2.default {
  ...
  static appliesToParameters(state, command, phase, options, ...parameters) {
    return (0, _asyncToGenerator3.default)(function* () {
      return state.isGrandparentOf(parameters[0], parameters[1]) && !!parameters[1].value && !!parameters[1].value.bibdata;
    })();
  }
  ...
  initialize() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      yield _this.getResolvedInputs(['$OUTDIR/$JOB.log-ParsedLaTeXLog', '$DIR_0/$NAME_0.blg-ParsedBibTeXLog', '$FILEPATH_0']);
    })();
  }
