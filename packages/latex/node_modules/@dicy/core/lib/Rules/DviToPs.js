...
class DviToPs extends _Rule2.default {
  ...
  constructCommand() {
    return {
      args: ['dvips', '-o', '{{$DIR_0/$NAME_0.ps}}', '{{$FILEPATH_0}}'],
      cd: '$ROOTDIR',
      severity: 'error',
...
exports.default = DviToPs;
DviToPs.parameterTypes = [new _set2.default(['DeviceIndependentFile'])];
DviToPs.description = 'Converts DVI to PS using dvips.';